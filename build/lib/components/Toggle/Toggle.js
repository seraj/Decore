...
import { HiddenCheckbox, CheckboxContainer } from "../Checkbox/styled/StyledCheckbox";
var Toggle = function (_a) {
    ...
    return (React.createElement(CheckboxContainer, { className: className },
        ...
        React.createElement(StyledToggle, __assign({}, props, { checked: checked, disabled: disabled }))));
};
